class Constants:
    ...
    broadcast_topic_op = enum(
        Union="UNION", Intersection="INTERSECTION", Except="EXCEPT"
    )
    ...
    """
    target_type = enum(
        TARGET_TYPE_REGID=1, TARGET_TYPE_ALIAS=2, TARGET_TYPE_USER_ACCOUNT=3
    )
    ...
    request_path = enum(
        ...
        V1_FEEDBACK_INVALID_ALIAS=[
            "/v1/feedback/fetch_invalid_aliases",
            request_type.Feedback,
        ],
        V1_FEEDBACK_INVALID_REGID=[
            "/v1/feedback/fetch_invalid_regids",
            request_type.Feedback,
        ],
